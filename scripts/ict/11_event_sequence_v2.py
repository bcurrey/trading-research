...
OUTDIR = ROOT / r"research_outputs\event_sequence_v2"
OUTDIR.mkdir(parents=True, exist_ok=True)

TRADES_OUT = OUTDIR / "event_sequence_v2_trades.csv"
SUMMARY_OUT = OUTDIR / "event_sequence_v2_summary.csv"
YEARLY_OUT = OUTDIR / "event_sequence_v2_yearly.csv"
...
def main():
    ...
    print("Running event sequence V2...")
