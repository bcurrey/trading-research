...
def main() -> None:
    ...
    ts_col = pick_col(df, [
        ...
        "bar_time", "bar_datetime", "start_time", "time_start",
        "dt", "t", "local_time", "ct_time", "central_time",
        "timestamp_ct", "datetime_ct", "datetime_central",
    ...
    rel_vol_col = pick_col(df, ["rel_vol_20", "rel_volume", "relative_volume", "volume_rel", "rvol", "rel_vol_50"], required=False)
