# 44_build_sniper_signal_engine.py
...
OUTDIR = ROOT / r"research_outputs\sniper_signal_engine"
...
# Sniper discovery rules from script 43
signals = df.filter(
...
signals.write_csv(OUTDIR / "sniper_signals.csv")
trades_df.write_csv(OUTDIR / "sniper_engine_trades.csv")
summary.write_csv(OUTDIR / "sniper_engine_summary.csv")
yearly.write_csv(OUTDIR / "sniper_engine_yearly.csv")
trades_df.filter(pl.col("result_points") <= 0).write_csv(OUTDIR / "sniper_engine_losers.csv")
